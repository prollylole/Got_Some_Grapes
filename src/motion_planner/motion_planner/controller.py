...
class Controller(Node):
    ...
    def check_goal_reached_manually(self):
        ...
        if dist < 0.3 and is_stuck and not self.waiting_for_continue and not self.checking_item:
            if is_stuck:
    ...
    def check_item_availability_async(self, item_name):
        try:
            ...
            # publish continue call so robot can drive to next waypoint
            self.continue_callback(msg)
